...
public class TencentUploadUtil {
    ...
    //读取配置文件，初始化配置
    static {
        secretId = "AKIDbx5zc0UyXrujHXdEk8tT0IcDahX7p3jJ";
        secretKey = "NUFjwtZ0B8poY29E5fzlGVTBfssnbAZk";
        bucket = "yzz-1304764762";
        region = "ap-nanjing";
        allowPrefix = "*";
        durationSeconds = "1800";
        baseUrl = "https://yzz-1304764762.cos.ap-nanjing.myqcloud.com/";
    }
